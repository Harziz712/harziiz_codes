...
const ProfileCard = () => {
  ...
  return (
    <div
      id="profile"
      className="min-h-screen bg-black text-white pb-24 border-b-2 border-b-neutral-600"
    >
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        >
          <div className="flex items-center justify-center my-5">
            <StylishBadge className="border border-neutral-700">
              Software Engineer
            </StylishBadge>
          </div>
          <motion.h1
              ...
              >
                ...
                >
                  ...
                  <div className="flex space-x-3">
                    ...
                    <SocialIcon
                      icon={Instagram}
                      href="https://www.instagram.com/harzzie711/"
                      delay={0.7}
                    />
                    <SocialIcon
                      icon={Linkedin}
            ...
            >
              ...
              >
                <p className="text-neutral-300 text-sm md:text-md leading-relaxed">
                  I'm Akanbi AbdulAzeez — a Frontend Developer and Software
                  Engineer based in Lagos, Nigeria. I specialize in building
                  fast, intuitive, and scalable digital products using modern
                  technologies. I blend clean UI/UX design with strong
                  engineering principles to deliver high-quality experiences
                  across web and mobile.
                  <br />
                  <br />
                  Beyond frontend development, I work with DevOps tools and
                  AI-driven workflows to help products scale efficiently. I
                  integrate cloud services, automate processes, and leverage
                  machine intelligence to create smarter, more reliable systems.
                </p>

                <div className="flex flex-wrap gap-3">
                  <Badge delay={0.4}>React Native</Badge>
                  <Badge delay={0.5}>React</Badge>
                  <Badge delay={0.6}>Next.js</Badge>
                  <Badge delay={0.7}>TypeScript</Badge>
                  <Badge delay={0.8}>AWS & DevOps</Badge>
                  <Badge delay={0.9}>Python</Badge>
                  <Badge delay={1.0}>Mobile App Development</Badge>
                  <Badge delay={1.1}>UI/UX Design</Badge>
                  <Badge delay={1.2}>Automation (Zapier / n8n / Make)</Badge>
                  <Badge delay={1.3}>AI Engineering</Badge>
                  <Badge delay={1.4}>Node.js</Badge>
                </div>
              </motion.div>
              ...
              >
                ...
                <ExperienceItem
                  role="UI/UX Design"
                  company="OJAA Digital Marketplace"
                  year="2024"
                  delay={0.9}
                />
              </motion.div>

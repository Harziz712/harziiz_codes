...
const DesignServices = () => {
  return (
    <section
      id="services"
      className="bg-black text-white px-4 py-16 md:px-8 lg:px-20 border-b-2 pb-24 border-b-neutral-600"
    >
      <div className="text-center mb-12">
        ...
        >
          <div
            className={`flex items-center justify-center my-5 object-cover `}
          >
            <StylishBadge className="border border-gray-700 ">
              Design Services
            </StylishBadge>
          </div>
          <div className="md:flex space-y-10 md:space-y-0 justify-between md:px-10  px-2items-center">
            <div className="items-left justify-end text-left">
              ...
              <p className="text-gray-400 mt-2 sm:text-xs md:text-md">
                Explore a suite of design services to elevate your brand and
                <br /> user experience from stunning websites to productive
            ...
            <a
              ...
              className="px-6  py-3 h-10 sm:text-xs md:text-md rounded-full bg-neutral-800 text-white font-medium hover:bg-neutral-700 transition"
            >
              Contact Now
            </a>
          </div>
...
function ServicesSection() {
  return (
    <div className=" relative overflow-hidden  group cursor-pointer z-20 bg-transparent p-4 md:p-8 ">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2  md:max-h-[110vh] sm:pb-20 md:pb-0">
          ...
          <div className="grid grid-cols-1  md:grid-rows-2  md:max-h-[90vh]">
            <div className="md:col-span-2 lg:col-span-2 xl:col-span-2 space-y-5">
              <AnimateCard className="relative h-110 gap-10 md:gap-0 md:h-100 p-3 rounded-2xl bg-gradient-to-br from-neutral-800 to-neutral-900 grid grid-rows-3">
                <ServicesDetails
              ...
              <AnimateCard className="md:col-span-2 lg:col-span-2 xl:col-span-2 h-40 p-3 rounded-2xl bg-gradient-to-br from-neutral-800 to-neutral-900">
                <ServicesDetails
                  title="DevOps"
                  description="Implementing reliable, scalable, and automated infrastructure using modern DevOps practices to ensure seamless deployment, enhanced performance, and continuous delivery across applications."
                  index={2}
                />
              </AnimateCard>
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-rows-2  md:max-h-[90vh] ">
            <div className="md:col-span-2 lg:col-span-2 xl:col-span-2 space-y-5">
              ...
              <AnimateCard className="relative h-100 md:h-100 p-3 rounded-2xl bg-gradient-to-br from-neutral-800 to-neutral-900 grid grid-rows-3">
                <ServicesDetails
